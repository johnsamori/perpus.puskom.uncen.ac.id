...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // No_Reg_Anggota
        $this->No_Reg_Anggota->setDbValueDef($newRow, $this->No_Reg_Anggota->CurrentValue, false);

        // Fakultas
        $this->Fakultas->setDbValueDef($newRow, $this->Fakultas->CurrentValue, false);
        ...
        // Jenjang
        $this->Jenjang->setDbValueDef($newRow, $this->Jenjang->CurrentValue, false);
        return $newRow;
    }
