...
class Suratket
{
	...
	// Page object name
    public string $PageObjName = "suratket"; // Modified by Masino Sinaga, December 18, 2023
    ...
    public string $CurrentPageName = "suratketcontroller";
    ...
    public function __construct(protected Language $language, protected AdvancedSecurity $security)
    {
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'suratket.php');
        }
...
// Use layout
    ...
    {
        Breadcrumb()->add("custom", "suratket", CurrentUrl(), "", "suratket", true);
        $this->Heading = Language()->tablePhrase("suratket", "TblCaption");
    }
