...
class Languages extends DbTable
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        $this->_Default->Raw = true;
        $this->_Default->setDataType(DataType::BOOLEAN);
        $this->_Default->TrueValue = "Y";
        $this->_Default->FalseValue = "N";
        global $CurrentLanguage;
        switch ($CurrentLanguage) {
            case "en-US":
                $this->_Default->Lookup = new Lookup($this->_Default, 'languages', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
            case "id-ID":
                $this->_Default->Lookup = new Lookup($this->_Default, 'languages', false, '', ["","","",""], '', "", [], [], [], [], [], [], false, '', '', "");
                break;
