 ...
 * Page class
 */
class JurusanView extends Jurusan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "JurusanView";
    ...
    // CSS class/style
    public string $CurrentPageName = "jurusanview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_jurusan") ?? Route("id_jurusan")) !== null) {
            $this->RecKey["id_jurusan"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_jurusan") ?? Route("id_jurusan")) !== null) {
            ...
            $this->RecKey["id_jurusan"] = $this->id_jurusan->QueryStringValue;
        } elseif (Post("id_jurusan") !== null) {
            $this->id_jurusan->setFormValue(Post("id_jurusan"));
            $this->RecKey["id_jurusan"] = $this->id_jurusan->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_jurusan->setQueryStringValue($keyValue);
            $this->RecKey["id_jurusan"] = $this->id_jurusan->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "jurusanlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "jurusanlist"; // No matching record, return to list
                    } else {
