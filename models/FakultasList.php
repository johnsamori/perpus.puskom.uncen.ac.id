...
class FakultasList extends Fakultas
{
    ...
    {
        $this->id_fakulttas->setVisibility();
    ...
    protected function hideFieldsForAddEdit(): void
    {
        if ($this->isAdd() || $this->isCopy() || $this->isGridAdd()) {
            $this->id_fakulttas->Visible = false;
        }
    }
...
// Is modal
		...
		if (@$_COOKIE['fakultas_searchpanel'] == 'notactive' || @$_COOKIE['fakultas_searchpanel'] == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['fakultas_searchpanel'] == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        $filterList = Concat($filterList, $this->id_fakulttas->AdvancedSearch->toJson(), ","); // Field id_fakulttas
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field id_fakulttas
        $this->id_fakulttas->AdvancedSearch->SearchValue = $filter["x_id_fakulttas"] ?? "";
        $this->id_fakulttas->AdvancedSearch->SearchOperator = $filter["z_id_fakulttas"] ?? "";
        $this->id_fakulttas->AdvancedSearch->SearchCondition = $filter["v_id_fakulttas"] ?? "";
        $this->id_fakulttas->AdvancedSearch->SearchValue2 = $filter["y_id_fakulttas"] ?? "";
        $this->id_fakulttas->AdvancedSearch->SearchOperator2 = $filter["w_id_fakulttas"] ?? "";
        $this->id_fakulttas->AdvancedSearch->save();
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->id_fakulttas); // id_fakulttas
    ...
    public function renderListOptions(): void
    {
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->id_fakulttas->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions(): void
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($this->language->phrase("DeleteSelectedLink")) . "\" form=\"ffakultaslist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "id_fakulttas");
...
// Load basic search values
    ...
    public function loadRowValues(array|bool|null $row = null): void
    {
        ...
        $this->id_fakulttas->setDbValue($row['id_fakulttas']);
    ...
    {
        $row = [];
        $row['id_fakulttas'] = $this->id_fakulttas->DefaultValue;
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            // id_fakulttas
            $this->id_fakulttas->ViewValue = $this->id_fakulttas->CurrentValue;

            // Nama_Fakultas
            $this->Nama_Fakultas->ViewValue = $this->Nama_Fakultas->CurrentValue;

            // id_fakulttas
            $this->id_fakulttas->HrefValue = "";
            $this->id_fakulttas->TooltipValue = "";
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (@$_COOKIE['fakultas_searchpanel'] == 'notactive' || @$_COOKIE['orders_searchpanel'] == "") {
