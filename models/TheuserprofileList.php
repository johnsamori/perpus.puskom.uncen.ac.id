...
// Is modal
		...
		if (@$_COOKIE['theuserprofile_searchpanel'] == 'notactive' || @$_COOKIE['theuserprofile_searchpanel'] == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['theuserprofile_searchpanel'] == 'active') {
    ...
    protected function setupOtherOptions(): void
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($this->language->phrase("DeleteSelectedLink")) . "\" form=\"ftheuserprofilelist\"" .
...
// Load basic search values
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (@$_COOKIE['theuserprofile_searchpanel'] == 'notactive' || @$_COOKIE['orders_searchpanel'] == "") {
