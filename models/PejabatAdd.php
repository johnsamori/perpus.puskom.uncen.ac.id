 ...
 * Page class
 */
class PejabatAdd extends Pejabat
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "PejabatAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "pejabatadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "pejabatview") {
...
// Get upload files
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($this->Nip->CurrentValue != "") { // Check field with unique index
            $filter = "(`Nip` = '" . AdjustSql($this->Nip->CurrentValue) . "')";
        ...
        if ($insertRow && $this->ValidateKey && strval($newRow['Nip']) == "") {
