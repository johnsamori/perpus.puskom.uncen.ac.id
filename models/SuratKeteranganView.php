 ...
 * Page class
 */
class SuratKeteranganView extends SuratKeterangan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SuratKeteranganView";
    ...
    // CSS class/style
    public string $CurrentPageName = "suratketeranganview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("Nomor_Surat") ?? Route("Nomor_Surat")) !== null) {
            $this->RecKey["Nomor_Surat"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("Nomor_Surat") ?? Route("Nomor_Surat")) !== null) {
            ...
            $this->RecKey["Nomor_Surat"] = $this->Nomor_Surat->QueryStringValue;
        } elseif (Post("Nomor_Surat") !== null) {
            $this->Nomor_Surat->setFormValue(Post("Nomor_Surat"));
            $this->RecKey["Nomor_Surat"] = $this->Nomor_Surat->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nomor_Surat->setQueryStringValue($keyValue);
            $this->RecKey["Nomor_Surat"] = $this->Nomor_Surat->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "suratketeranganlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "suratketeranganlist"; // No matching record, return to list
                    } else {
