 ...
 * Page class
 */
class JurusanDelete extends Jurusan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "JurusanDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "jurusandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("jurusanlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("jurusanlist"); // Return to list
                return;
            }
        }
