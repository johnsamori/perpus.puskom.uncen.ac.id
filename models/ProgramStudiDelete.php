 ...
 * Page class
 */
class ProgramStudiDelete extends ProgramStudi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProgramStudiDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "programstudidelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("programstudilist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("programstudilist"); // Return to list
                return;
            }
        }
