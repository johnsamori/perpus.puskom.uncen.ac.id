...
// Load search values for validation
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->BirthDate->setupEditAttributes();
            $this->BirthDate->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->BirthDate->AdvancedSearch->SearchValue2, $this->BirthDate->formatPattern()), $this->BirthDate->formatPattern()));
            $this->BirthDate->PlaceHolder = RemoveHtml($this->BirthDate->caption());
            ...
            if (!$this->MessengerColor->Raw) {
                $this->MessengerColor->AdvancedSearch->SearchValue = HtmlDecode($this->MessengerColor->AdvancedSearch->SearchValue);
            }
            $this->MessengerColor->EditValue = HtmlEncode($this->MessengerColor->AdvancedSearch->SearchValue);
            $this->MessengerColor->PlaceHolder = RemoveHtml($this->MessengerColor->caption());

            // CreatedAt
            $this->CreatedAt->setupEditAttributes();
            $this->CreatedAt->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->CreatedAt->AdvancedSearch->SearchValue, $this->CreatedAt->formatPattern()), $this->CreatedAt->formatPattern()));
            $this->CreatedAt->PlaceHolder = RemoveHtml($this->CreatedAt->caption());
            $this->CreatedAt->setupEditAttributes();
            $this->CreatedAt->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->CreatedAt->AdvancedSearch->SearchValue2, $this->CreatedAt->formatPattern()), $this->CreatedAt->formatPattern()));
            $this->CreatedAt->PlaceHolder = RemoveHtml($this->CreatedAt->caption());
            ...
            if ($this->CreatedBy->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                $ari = count($rswrk);
                $arwrk = $rswrk;
                $this->CreatedBy->EditValue = $arwrk;
            }
            $this->CreatedBy->PlaceHolder = RemoveHtml($this->CreatedBy->caption());

            // UpdatedAt
            $this->UpdatedAt->setupEditAttributes();
            $this->UpdatedAt->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->UpdatedAt->AdvancedSearch->SearchValue, $this->UpdatedAt->formatPattern()), $this->UpdatedAt->formatPattern()));
            $this->UpdatedAt->PlaceHolder = RemoveHtml($this->UpdatedAt->caption());
            $this->UpdatedAt->setupEditAttributes();
            $this->UpdatedAt->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->UpdatedAt->AdvancedSearch->SearchValue2, $this->UpdatedAt->formatPattern()), $this->UpdatedAt->formatPattern()));
            $this->UpdatedAt->PlaceHolder = RemoveHtml($this->UpdatedAt->caption());
            ...
            if ($this->UpdatedBy->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                $ari = count($rswrk);
                $arwrk = $rswrk;
                $this->UpdatedBy->EditValue = $arwrk;
            }
