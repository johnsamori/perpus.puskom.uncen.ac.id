...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("Category_Description") ? $this->getFormValue("Category_Description") : $this->getFormValue("x_Category_Description");
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (!$this->Category_Description->Raw) {
                $this->Category_Description->CurrentValue = HtmlDecode($this->Category_Description->CurrentValue);
            }
