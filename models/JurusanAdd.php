 ...
 * Page class
 */
class JurusanAdd extends Jurusan
{
    use MessagesTrait;
    use FormTrait;
    ...
    // Page object name
    public string $PageObjName = "JurusanAdd";
    ...
    // CSS class/style
    public string $CurrentPageName = "jurusanadd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                if ($this->addRow($oldRow)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "jurusanview") {
...
// Get upload files
    ...
    protected function getAddRow(): array
    {
        ...
        // Jurusan
        $this->Jurusan->setDbValueDef($newRow, $this->Jurusan->CurrentValue, false);
        return $newRow;
    }
