...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("Is_Active") ? $this->getFormValue("Is_Active") : $this->getFormValue("x_Is_Active");
        ...
        $val = $this->hasFormValue("Topic") ? $this->getFormValue("Topic") : $this->getFormValue("x_Topic");
        ...
        // Check field name 'Message' before field var 'x__Message'
        $val = $this->hasFormValue("Message") ? $this->getFormValue("Message") : $this->getFormValue("x__Message");
        ...
        $val = $this->hasFormValue("Date_LastUpdate") ? $this->getFormValue("Date_LastUpdate") : $this->getFormValue("x_Date_LastUpdate");
        ...
        $val = $this->hasFormValue("Language") ? $this->getFormValue("Language") : $this->getFormValue("x__Language");
        ...
        $val = $this->hasFormValue("Auto_Publish") ? $this->getFormValue("Auto_Publish") : $this->getFormValue("x_Auto_Publish");
        ...
        $val = $this->hasFormValue("Date_Start") ? $this->getFormValue("Date_Start") : $this->getFormValue("x_Date_Start");
        ...
        $val = $this->hasFormValue("Date_End") ? $this->getFormValue("Date_End") : $this->getFormValue("x_Date_End");
        ...
        $val = $this->hasFormValue("Date_Created") ? $this->getFormValue("Date_Created") : $this->getFormValue("x_Date_Created");
        ...
        $val = $this->hasFormValue("Created_By") ? $this->getFormValue("Created_By") : $this->getFormValue("x_Created_By");
        ...
        $val = $this->hasFormValue("Translated_ID") ? $this->getFormValue("Translated_ID") : $this->getFormValue("x_Translated_ID");
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->_Message->Visible && $this->_Message->Required) {
                if (!$this->_Message->IsDetailKey && IsEmpty($this->_Message->FormValue)) {
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        // Message
        $this->_Message->setDbValueDef($newRow, $this->_Message->CurrentValue, $this->_Message->ReadOnly);
