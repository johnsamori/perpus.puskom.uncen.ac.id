 ...
 * Page class
 */
class PejabatDelete extends Pejabat
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PejabatDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "pejabatdelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("pejabatlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("pejabatlist"); // Return to list
                return;
            }
        }
