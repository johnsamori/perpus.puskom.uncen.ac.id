...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("Name") ? $this->getFormValue("Name") : $this->getFormValue("x_Name");
        ...
        $val = $this->hasFormValue("Hierarchy") ? $this->getFormValue("Hierarchy") : $this->getFormValue("x_Hierarchy");
        ...
        $val = $this->hasFormValue("Level_Origin") ? $this->getFormValue("Level_Origin") : $this->getFormValue("x_Level_Origin");
    ...
    public function renderRow(): void
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->Hierarchy->ViewValue !== null) { // Load from cache
                ...
                $ari = count($rswrk);
                $arwrk = $rswrk;
                $this->Hierarchy->EditValue = $arwrk;
            }
            ...
            if ($this->Level_Origin->ViewValue !== null) { // Load from cache
                ...
                $ari = count($rswrk);
                $arwrk = $rswrk;
                $this->Level_Origin->EditValue = $arwrk;
            }
    ...
    protected function addRow(?array $oldRow = null): bool
    {
        ...
        if ($addRow) {
            ...
            if (in_array("users", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->_UserLevel->setSessionValue($this->ID->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->_UserLevel->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
