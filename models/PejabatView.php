 ...
 * Page class
 */
class PejabatView extends Pejabat
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "PejabatView";
    ...
    // CSS class/style
    public string $CurrentPageName = "pejabatview";
...
// Is modal
        ...
        if (($keyValue = Get("Nip") ?? Route("Nip")) !== null) {
            ...
            $returnUrl = "pejabatlist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "pejabatlist"; // No matching record, return to list
                    } else {
