 ...
 * Page class
 */
class ProgramStudiView extends ProgramStudi
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "ProgramStudiView";
    ...
    // CSS class/style
    public string $CurrentPageName = "programstudiview";
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_programstudi") ?? Route("id_programstudi")) !== null) {
            $this->RecKey["id_programstudi"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_programstudi") ?? Route("id_programstudi")) !== null) {
            ...
            $this->RecKey["id_programstudi"] = $this->id_programstudi->QueryStringValue;
        } elseif (Post("id_programstudi") !== null) {
            $this->id_programstudi->setFormValue(Post("id_programstudi"));
            $this->RecKey["id_programstudi"] = $this->id_programstudi->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->id_programstudi->setQueryStringValue($keyValue);
            $this->RecKey["id_programstudi"] = $this->id_programstudi->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "programstudilist"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "programstudilist"; // No matching record, return to list
                    } else {
