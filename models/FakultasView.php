...
class FakultasView extends Fakultas
{
    ...
    public function __construct(Language $language, AdvancedSecurity $security)
    {
        ...
        if (($keyValue = Get("id_fakulttas") ?? Route("id_fakulttas")) !== null) {
            $this->RecKey["id_fakulttas"] = $keyValue;
        }
...
// Is modal
        ...
        if (($keyValue = Get("id_fakulttas") ?? Route("id_fakulttas")) !== null) {
            ...
            $this->RecKey["id_fakulttas"] = $this->id_fakulttas->QueryStringValue;
        } elseif (Post("id_fakulttas") !== null) {
            $this->id_fakulttas->setFormValue(Post("id_fakulttas"));
            $this->RecKey["id_fakulttas"] = $this->id_fakulttas->FormValue;
