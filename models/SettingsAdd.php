...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("Option_Default") ? $this->getFormValue("Option_Default") : $this->getFormValue("x_Option_Default");
        ...
        $val = $this->hasFormValue("Show_Announcement") ? $this->getFormValue("Show_Announcement") : $this->getFormValue("x_Show_Announcement");
        ...
        $val = $this->hasFormValue("Use_Announcement_Table") ? $this->getFormValue("Use_Announcement_Table") : $this->getFormValue("x_Use_Announcement_Table");
        ...
        $val = $this->hasFormValue("Maintenance_Mode") ? $this->getFormValue("Maintenance_Mode") : $this->getFormValue("x_Maintenance_Mode");
        ...
        $val = $this->hasFormValue("Maintenance_Finish_DateTime") ? $this->getFormValue("Maintenance_Finish_DateTime") : $this->getFormValue("x_Maintenance_Finish_DateTime");
        ...
        $val = $this->hasFormValue("Auto_Normal_After_Maintenance") ? $this->getFormValue("Auto_Normal_After_Maintenance") : $this->getFormValue("x_Auto_Normal_After_Maintenance");
