...
// Get upload files
    ...
    protected function loadFormValues(): void
    {
        ...
        $val = $this->hasFormValue("Language_Code") ? $this->getFormValue("Language_Code") : $this->getFormValue("x_Language_Code");
        ...
        $val = $this->hasFormValue("Language_Name") ? $this->getFormValue("Language_Name") : $this->getFormValue("x_Language_Name");
        ...
        // Check field name 'Default' before field var 'x__Default'
        $val = $this->hasFormValue("Default") ? $this->getFormValue("Default") : $this->getFormValue("x__Default");
        ...
        $val = $this->hasFormValue("Site_Logo") ? $this->getFormValue("Site_Logo") : $this->getFormValue("x_Site_Logo");
        ...
        $val = $this->hasFormValue("Site_Title") ? $this->getFormValue("Site_Title") : $this->getFormValue("x_Site_Title");
        ...
        $val = $this->hasFormValue("Default_Thousands_Separator") ? $this->getFormValue("Default_Thousands_Separator") : $this->getFormValue("x_Default_Thousands_Separator");
        ...
        $val = $this->hasFormValue("Default_Decimal_Point") ? $this->getFormValue("Default_Decimal_Point") : $this->getFormValue("x_Default_Decimal_Point");
        ...
        $val = $this->hasFormValue("Default_Currency_Symbol") ? $this->getFormValue("Default_Currency_Symbol") : $this->getFormValue("x_Default_Currency_Symbol");
        ...
        $val = $this->hasFormValue("Default_Money_Thousands_Separator") ? $this->getFormValue("Default_Money_Thousands_Separator") : $this->getFormValue("x_Default_Money_Thousands_Separator");
        ...
        $val = $this->hasFormValue("Default_Money_Decimal_Point") ? $this->getFormValue("Default_Money_Decimal_Point") : $this->getFormValue("x_Default_Money_Decimal_Point");
        ...
        $val = $this->hasFormValue("Terms_And_Condition_Text") ? $this->getFormValue("Terms_And_Condition_Text") : $this->getFormValue("x_Terms_And_Condition_Text");
        ...
        $val = $this->hasFormValue("Announcement_Text") ? $this->getFormValue("Announcement_Text") : $this->getFormValue("x_Announcement_Text");
        ...
        $val = $this->hasFormValue("About_Text") ? $this->getFormValue("About_Text") : $this->getFormValue("x_About_Text");
    ...
    protected function validateForm(): bool
    {
        ...
        $validateForm = true;
            ...
            if ($this->_Default->Visible && $this->_Default->Required) {
    ...
    protected function getEditRow(array $oldRow): array
    {
        ...
        $this->_Default->setDbValueDef($newRow, $tmpBool, $this->_Default->ReadOnly);
    ...
    protected function restoreEditFormFromRow(array $row): void
    {
        ...
        if (isset($row['Default'])) { // Default
            $this->_Default->CurrentValue = $row['Default'];
        }
