...
// Is modal
		...
		if (@$_COOKIE['languages_searchpanel'] == 'notactive' || @$_COOKIE['languages_searchpanel'] == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['languages_searchpanel'] == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        $filterList = Concat($filterList, $this->_Default->AdvancedSearch->toJson(), ","); // Field Default
    ...
    protected function setupOtherOptions(): void
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($this->language->phrase("DeleteSelectedLink")) . "\" form=\"flanguageslist\"" .
...
// Load basic search values
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (@$_COOKIE['languages_searchpanel'] == 'notactive' || @$_COOKIE['orders_searchpanel'] == "") {
