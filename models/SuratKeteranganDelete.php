 ...
 * Page class
 */
class SuratKeteranganDelete extends SuratKeterangan
{
    use MessagesTrait;
    ...
    // Page object name
    public string $PageObjName = "SuratKeteranganDelete";
    ...
    // CSS class/style
    public string $CurrentPageName = "suratketerangandelete";
...
// Use layout
        ...
        if ($filter == "") {
            $this->terminate("suratketeranganlist"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Result?->free();
                $this->terminate("suratketeranganlist"); // Return to list
                return;
            }
        }
