...
// Is modal
		...
		if (@$_COOKIE['mahasiswa_searchpanel'] == 'notactive' || @$_COOKIE['mahasiswa_searchpanel'] == "") {
			RemoveClass($this->SearchPanelClass, "show");
			AppendClass($this->SearchPanelClass, "collapse");
		} elseif (@$_COOKIE['mahasiswa_searchpanel'] == 'active') {
    ...
    public function getFilterList(): string
    {
        ...
        $filterList = Concat($filterList, $this->Fakultas->AdvancedSearch->toJson(), ","); // Field Fakultas
    ...
    protected function restoreFilterList(): void
    {
        ...
        // Field Fakultas
        $this->Fakultas->AdvancedSearch->SearchValue = $filter["x_Fakultas"] ?? "";
        $this->Fakultas->AdvancedSearch->SearchOperator = $filter["z_Fakultas"] ?? "";
        $this->Fakultas->AdvancedSearch->SearchCondition = $filter["v_Fakultas"] ?? "";
        $this->Fakultas->AdvancedSearch->SearchValue2 = $filter["y_Fakultas"] ?? "";
        $this->Fakultas->AdvancedSearch->SearchOperator2 = $filter["w_Fakultas"] ?? "";
        $this->Fakultas->AdvancedSearch->save();
    ...
    protected function setupSortOrder(): void
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Fakultas); // Fakultas
    ...
    protected function setupOtherOptions(): void
    {
        ...
        $item->Body = "<button type=\"button\" class=\"ew-action ew-multi-delete\" title=\"" .
            ...
            HtmlTitle($this->language->phrase("DeleteSelectedLink")) . "\" form=\"fmahasiswalist\"" .
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Fakultas");
...
// Load basic search values
	...
	// Begin of add Search Panel Status by Masino Sinaga, October 13, 2024
		...
		if (@$_COOKIE['mahasiswa_searchpanel'] == 'notactive' || @$_COOKIE['orders_searchpanel'] == "") {
