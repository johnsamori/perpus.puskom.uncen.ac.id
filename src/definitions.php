...
return [
    ...
    "jurusan" => \DI\autowire(Jurusan::class),
    "mahasiswa" => \DI\autowire(Mahasiswa::class),
    "pejabat" => \DI\autowire(Pejabat::class),
    "program_studi" => \DI\autowire(ProgramStudi::class),
    "surat_keterangan" => \DI\autowire(SuratKeterangan::class),
    "suratket" => \DI\autowire(Suratket::class),
    "vsrtket" => \DI\autowire(Vsrtket::class),
