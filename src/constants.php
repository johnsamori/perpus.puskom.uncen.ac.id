...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "25.3.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "perpus2025baru"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{72B3345B-D446-402B-9B28-F1CD922DC9A6}"); // Project ID
...
define(PROJECT_NAMESPACE . "MS_USE_MESSAGE_BOX_INSTEAD_OF_TOAST", false); 
