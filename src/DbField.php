...
class DbField
{
    ...
    // Form value
    public function setFormValue(mixed $v, bool $current = true, bool $validate = true): void
    {
    ...
    // Form value (Raw)
    public function setRawFormValue(mixed $v, bool $current = true, bool $validate = true): void
    {
        if (is_array($v)) {
    ...
    // Old value
    public function setOldValue(mixed $v): void
    {
        if (is_array($v)) {
            $v = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $v);
        }
    ...
    // QueryString value
    public function setQueryStringValue(mixed $v, bool $current = true): void
    {
        if (!$this->Raw) {
            $v = RemoveXss($v);
        }
    ...
    public function setRawQueryStringValue(mixed $v, bool $current = true): void
    {
        if (is_array($v)) {
            $v = implode(Config("MULTIPLE_OPTION_SEPARATOR"), $v);
        }
    ...
    // Database value
    public function setDbValue(mixed $v): void
    {
