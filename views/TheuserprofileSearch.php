...
<input type="<?= $Page->_UserID->getInputTextType() ?>" name="x__UserID" id="x__UserID" data-table="theuserprofile" data-field="x__UserID" value="<?= $Page->_UserID->EditValue ?>" placeholder="<?= HtmlEncode($Page->_UserID->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_UserID->formatPattern()) ?>"<?= $Page->_UserID->editAttributes() ?>>
...
<?php if ($Page->_UserLevel->Visible) { // UserLevel ?>
    <div id="r__UserLevel" class="row"<?= $Page->_UserLevel->rowAttributes() ?>>
        <label for="x__UserLevel" class="<?= $Page->LeftColumnClass ?>"><span id="elh_theuserprofile__UserLevel"><?= $Page->_UserLevel->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z__UserLevel" id="z__UserLevel" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->_UserLevel->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_theuserprofile__UserLevel" class="ew-search-field ew-search-field-single">
    <select
        id="x__UserLevel"
        name="x__UserLevel"
        class="form-select ew-select<?= $Page->_UserLevel->isInvalidClass() ?>"
        <?php if (!$Page->_UserLevel->IsNativeSelect) { ?>
        data-select2-id="ftheuserprofilesearch_x__UserLevel"
        <?php } ?>
...
loadjs.ready("ftheuserprofilesearch", function() {
    var options = { name: "x__UserLevel", selectId: "ftheuserprofilesearch_x__UserLevel" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (ftheuserprofilesearch.lists._UserLevel?.lookupOptions.length) {
        options.data = { id: "x__UserLevel", form: "ftheuserprofilesearch" };
    } else {
        options.ajax = { id: "x__UserLevel", form: "ftheuserprofilesearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumInputLength = ew.selectMinimumInputLength;
    options = Object.assign({}, ew.selectOptions, options, ew.vars.tables.theuserprofile.fields._UserLevel.selectOptions);
...
<input type="<?= $Page->FirstName->getInputTextType() ?>" name="x_FirstName" id="x_FirstName" data-table="theuserprofile" data-field="x_FirstName" value="<?= $Page->FirstName->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->FirstName->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->FirstName->formatPattern()) ?>"<?= $Page->FirstName->editAttributes() ?>>
...
<input type="<?= $Page->Photo->getInputTextType() ?>" name="x_Photo" id="x_Photo" data-table="theuserprofile" data-field="x_Photo" value="<?= $Page->Photo->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Photo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Photo->formatPattern()) ?>"<?= $Page->Photo->editAttributes() ?>>
...
<input type="<?= $Page->Notes->getInputTextType() ?>" name="x_Notes" id="x_Notes" data-table="theuserprofile" data-field="x_Notes" value="<?= $Page->Notes->EditValue ?>" size="50" placeholder="<?= HtmlEncode($Page->Notes->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Notes->formatPattern()) ?>"<?= $Page->Notes->editAttributes() ?>>
...
<input type="<?= $Page->ReportsTo->getInputTextType() ?>" name="x_ReportsTo" id="x_ReportsTo" data-table="theuserprofile" data-field="x_ReportsTo" value="<?= $Page->ReportsTo->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->ReportsTo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->ReportsTo->formatPattern()) ?>"<?= $Page->ReportsTo->editAttributes() ?>>
...
<input type="<?= $Page->_Email->getInputTextType() ?>" name="x__Email" id="x__Email" data-table="theuserprofile" data-field="x__Email" value="<?= $Page->_Email->EditValue ?>" size="50" maxlength="255" placeholder="<?= HtmlEncode($Page->_Email->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_Email->formatPattern()) ?>"<?= $Page->_Email->editAttributes() ?>>
...
<input type="<?= $Page->Avatar->getInputTextType() ?>" name="x_Avatar" id="x_Avatar" data-table="theuserprofile" data-field="x_Avatar" value="<?= $Page->Avatar->EditValue ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->Avatar->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Avatar->formatPattern()) ?>"<?= $Page->Avatar->editAttributes() ?>>
...
<input type="<?= $Page->MessengerColor->getInputTextType() ?>" name="x_MessengerColor" id="x_MessengerColor" data-table="theuserprofile" data-field="x_MessengerColor" value="<?= $Page->MessengerColor->EditValue ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->MessengerColor->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->MessengerColor->formatPattern()) ?>"<?= $Page->MessengerColor->editAttributes() ?>>
