...
<input type="<?= $Page->ID->getInputTextType() ?>" name="x_ID" id="x_ID" data-table="userlevels" data-field="x_ID" value="<?= $Page->ID->EditValue ?>" size="10" maxlength="5" placeholder="<?= HtmlEncode($Page->ID->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->ID->formatPattern()) ?>"<?= $Page->ID->editAttributes() ?> aria-describedby="x_ID_help">
...
<input type="<?= $Page->Name->getInputTextType() ?>" name="x_Name" id="x_Name" data-table="userlevels" data-field="x_Name" value="<?= $Page->Name->EditValue ?>" size="50" maxlength="255" placeholder="<?= HtmlEncode($Page->Name->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Name->formatPattern()) ?>"<?= $Page->Name->editAttributes() ?> aria-describedby="x_Name_help">
