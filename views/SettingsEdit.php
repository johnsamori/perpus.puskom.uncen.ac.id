...
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->Option_ID->getDisplayValue($Page->Option_ID->EditValue))) ?>"></span>
...
<input type="<?= $Page->Maintenance_Finish_DateTime->getInputTextType() ?>" name="x_Maintenance_Finish_DateTime" id="x_Maintenance_Finish_DateTime" data-table="settings" data-field="x_Maintenance_Finish_DateTime" value="<?= $Page->Maintenance_Finish_DateTime->EditValue ?>" placeholder="<?= HtmlEncode($Page->Maintenance_Finish_DateTime->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Maintenance_Finish_DateTime->formatPattern()) ?>"<?= $Page->Maintenance_Finish_DateTime->editAttributes() ?> aria-describedby="x_Maintenance_Finish_DateTime_help">
