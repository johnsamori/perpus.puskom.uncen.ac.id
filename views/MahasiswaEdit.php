...
<span id="el_mahasiswa_Fakultas">
    <select
        ...
        data-select2-id="fmahasiswaedit_x_Fakultas"
        <?php } ?>
...
<?php if (!$Page->Fakultas->IsNativeSelect) { ?>
<script<?= Nonce() ?>>
loadjs.ready("fmahasiswaedit", function() {
    var options = { name: "x_Fakultas", selectId: "fmahasiswaedit_x_Fakultas" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmahasiswaedit.lists.Fakultas?.lookupOptions.length) {
        options.data = { id: "x_Fakultas", form: "fmahasiswaedit" };
    } else {
        options.ajax = { id: "x_Fakultas", form: "fmahasiswaedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_mahasiswa_Jurusan">
    <select
        ...
        data-select2-id="fmahasiswaedit_x_Jurusan"
        <?php } ?>
        data-table="mahasiswa"
...
<script<?= Nonce() ?>>
loadjs.ready("fmahasiswaedit", function() {
    var options = { name: "x_Jurusan", selectId: "fmahasiswaedit_x_Jurusan" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmahasiswaedit.lists.Jurusan?.lookupOptions.length) {
        options.data = { id: "x_Jurusan", form: "fmahasiswaedit" };
    } else {
        options.ajax = { id: "x_Jurusan", form: "fmahasiswaedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_mahasiswa_Program_Studi">
    <select
        ...
        data-select2-id="fmahasiswaedit_x_Program_Studi"
        <?php } ?>
        data-table="mahasiswa"
...
<script<?= Nonce() ?>>
loadjs.ready("fmahasiswaedit", function() {
    var options = { name: "x_Program_Studi", selectId: "fmahasiswaedit_x_Program_Studi" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fmahasiswaedit.lists.Program_Studi?.lookupOptions.length) {
        options.data = { id: "x_Program_Studi", form: "fmahasiswaedit" };
    } else {
        options.ajax = { id: "x_Program_Studi", form: "fmahasiswaedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
