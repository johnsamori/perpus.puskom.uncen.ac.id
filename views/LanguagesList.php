...
<?php if ($Page->_Default->Visible) { // Default ?>
        <th data-name="_Default" class="<?= $Page->_Default->headerCellClass() ?>"><div id="elh_languages__Default" class="languages__Default"><?= $Page->renderFieldHeader($Page->_Default) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_languages__Default" class="el_languages__Default">
...
loadjs.ready("jscookie", function() {
	...
	SearchToggle.on('click', function(event) { 
		...
		if (SearchToggle.hasClass('active')) { 
			Cookies.set("languages_searchpanel", "notactive", { path: '/', expires: expires }); 
		} else { 
			Cookies.set("languages_searchpanel", "active", { path: '/', expires: expires }); 
		} 
	});
});
</script>
