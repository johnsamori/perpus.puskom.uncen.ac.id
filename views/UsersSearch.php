...
<input type="<?= $Page->_UserID->getInputTextType() ?>" name="x__UserID" id="x__UserID" data-table="users" data-field="x__UserID" value="<?= $Page->_UserID->EditValue ?>" placeholder="<?= HtmlEncode($Page->_UserID->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_UserID->formatPattern()) ?>"<?= $Page->_UserID->editAttributes() ?>>
...
<?php if ($Page->_UserLevel->Visible) { // UserLevel ?>
    <div id="r__UserLevel" class="row"<?= $Page->_UserLevel->rowAttributes() ?>>
        <label for="x__UserLevel" class="<?= $Page->LeftColumnClass ?>"><span id="elh_users__UserLevel"><?= $Page->_UserLevel->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z__UserLevel" id="z__UserLevel" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>">
            <div<?= $Page->_UserLevel->cellAttributes() ?>>
                <div class="d-flex align-items-start">
                <span id="el_users__UserLevel" class="ew-search-field ew-search-field-single">
...
<?php } else { ?>
    <select
        ...
        data-select2-id="fuserssearch_x__UserLevel"
        <?php } ?>
        data-table="users"
...
loadjs.ready("fuserssearch", function() {
    var options = { name: "x__UserLevel", selectId: "fuserssearch_x__UserLevel" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserssearch.lists._UserLevel?.lookupOptions.length) {
        options.data = { id: "x__UserLevel", form: "fuserssearch" };
    } else {
        options.ajax = { id: "x__UserLevel", form: "fuserssearch", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<input type="<?= $Page->Photo->getInputTextType() ?>" name="x_Photo" id="x_Photo" data-table="users" data-field="x_Photo" value="<?= $Page->Photo->EditValue ?>" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->Photo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Photo->formatPattern()) ?>"<?= $Page->Photo->editAttributes() ?>>
...
<input type="<?= $Page->Notes->getInputTextType() ?>" name="x_Notes" id="x_Notes" data-table="users" data-field="x_Notes" value="<?= $Page->Notes->EditValue ?>" size="50" placeholder="<?= HtmlEncode($Page->Notes->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Notes->formatPattern()) ?>"<?= $Page->Notes->editAttributes() ?>>
...
<input type="<?= $Page->ReportsTo->getInputTextType() ?>" name="x_ReportsTo" id="x_ReportsTo" data-table="users" data-field="x_ReportsTo" value="<?= $Page->ReportsTo->EditValue ?>" size="30" placeholder="<?= HtmlEncode($Page->ReportsTo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->ReportsTo->formatPattern()) ?>"<?= $Page->ReportsTo->editAttributes() ?>>
...
<input type="<?= $Page->_Email->getInputTextType() ?>" name="x__Email" id="x__Email" data-table="users" data-field="x__Email" value="<?= $Page->_Email->EditValue ?>" size="50" maxlength="255" placeholder="<?= HtmlEncode($Page->_Email->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->_Email->formatPattern()) ?>"<?= $Page->_Email->editAttributes() ?>>
...
<input type="<?= $Page->Avatar->getInputTextType() ?>" name="x_Avatar" id="x_Avatar" data-table="users" data-field="x_Avatar" value="<?= $Page->Avatar->EditValue ?>" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->Avatar->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Avatar->formatPattern()) ?>"<?= $Page->Avatar->editAttributes() ?>>
