...
<?php if ($Page->_UserLevel->Visible) { // UserLevel ?>
    <?php if (!$Page->_UserLevel->Sortable || !$Page->sortUrl($Page->_UserLevel)) { ?>
        <th class="<?= $Page->_UserLevel->headerCellClass() ?>"><?= $Page->_UserLevel->caption() ?></th>
    <?php } else { ?>
        <th class="<?= $Page->_UserLevel->headerCellClass() ?>"><div role="button" data-table="users" data-sort="<?= HtmlEncode($Page->_UserLevel->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->_UserLevel->getNextSort() ?>">
            <div class="ew-table-header-btn">
                <span class="ew-table-header-caption"><?= $Page->_UserLevel->caption() ?></span>
                <span class="ew-table-header-sort"><?= $Page->_UserLevel->getSortIcon() ?></span>
            </div>
        </th>
    <?php } ?>
<?php } ?>
