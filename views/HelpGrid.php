...
<textarea data-table="help" data-field="x_Description" name="x<?= $Grid->RowIndex ?>_Description" id="x<?= $Grid->RowIndex ?>_Description" cols="50" rows="5" placeholder="<?= HtmlEncode($Grid->Description->getPlaceHolder()) ?>"<?= $Grid->Description->editAttributes() ?>><?= $Grid->Description->EditValue ?></textarea>
