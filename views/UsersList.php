...
<input type="hidden" name="z__UserLevel" id="z__UserLevel" value="=">
        ...
        <div id="el_users__UserLevel" class="ew-search-field">
...
<?php } else { ?>
    <select
        ...
        data-select2-id="fuserssrch_x__UserLevel"
        <?php } ?>
        data-table="users"
...
loadjs.ready("fuserssrch", function() {
    var options = { name: "x__UserLevel", selectId: "fuserssrch_x__UserLevel" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserssrch.lists._UserLevel?.lookupOptions.length) {
        options.data = { id: "x__UserLevel", form: "fuserssrch" };
    } else {
        options.ajax = { id: "x__UserLevel", form: "fuserssrch", limit: ew.LOOKUP_PAGE_SIZE };
    }
