...
<input type="<?= $Page->Language_Code->getInputTextType() ?>" name="x_Language_Code" id="x_Language_Code" data-table="languages" data-field="x_Language_Code" value="<?= $Page->Language_Code->EditValue ?>" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->Language_Code->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Language_Code->formatPattern()) ?>"<?= $Page->Language_Code->editAttributes() ?> aria-describedby="x_Language_Code_help">
...
<?php if ($Page->_Default->Visible) { // Default ?>
    <div id="r__Default"<?= $Page->_Default->rowAttributes() ?>>
        <label id="elh_languages__Default" class="<?= $Page->LeftColumnClass ?>"><?= $Page->_Default->caption() ?><?= $Page->_Default->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->_Default->cellAttributes() ?>>
<span id="el_languages__Default">
<div class="form-check form-switch d-inline-block">
    <input type="checkbox" class="form-check-input<?= $Page->_Default->isInvalidClass() ?>" data-table="languages" data-field="x__Default" data-boolean name="x__Default" id="x__Default" value="1"<?= ConvertToBool($Page->_Default->CurrentValue) ? " checked" : "" ?><?= $Page->_Default->editAttributes() ?> aria-describedby="x__Default_help">
...
<input type="<?= $Page->Site_Logo->getInputTextType() ?>" name="x_Site_Logo" id="x_Site_Logo" data-table="languages" data-field="x_Site_Logo" value="<?= $Page->Site_Logo->EditValue ?>" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->Site_Logo->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Site_Logo->formatPattern()) ?>"<?= $Page->Site_Logo->editAttributes() ?> aria-describedby="x_Site_Logo_help">
...
<input type="<?= $Page->Site_Title->getInputTextType() ?>" name="x_Site_Title" id="x_Site_Title" data-table="languages" data-field="x_Site_Title" value="<?= $Page->Site_Title->EditValue ?>" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->Site_Title->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Site_Title->formatPattern()) ?>"<?= $Page->Site_Title->editAttributes() ?> aria-describedby="x_Site_Title_help">
...
<input type="<?= $Page->Default_Decimal_Point->getInputTextType() ?>" name="x_Default_Decimal_Point" id="x_Default_Decimal_Point" data-table="languages" data-field="x_Default_Decimal_Point" value="<?= $Page->Default_Decimal_Point->EditValue ?>" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->Default_Decimal_Point->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Default_Decimal_Point->formatPattern()) ?>"<?= $Page->Default_Decimal_Point->editAttributes() ?> aria-describedby="x_Default_Decimal_Point_help">
...
<input type="<?= $Page->Default_Money_Thousands_Separator->getInputTextType() ?>" name="x_Default_Money_Thousands_Separator" id="x_Default_Money_Thousands_Separator" data-table="languages" data-field="x_Default_Money_Thousands_Separator" value="<?= $Page->Default_Money_Thousands_Separator->EditValue ?>" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->Default_Money_Thousands_Separator->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Default_Money_Thousands_Separator->formatPattern()) ?>"<?= $Page->Default_Money_Thousands_Separator->editAttributes() ?> aria-describedby="x_Default_Money_Thousands_Separator_help">
...
<input type="<?= $Page->Default_Money_Decimal_Point->getInputTextType() ?>" name="x_Default_Money_Decimal_Point" id="x_Default_Money_Decimal_Point" data-table="languages" data-field="x_Default_Money_Decimal_Point" value="<?= $Page->Default_Money_Decimal_Point->EditValue ?>" size="30" maxlength="5" placeholder="<?= HtmlEncode($Page->Default_Money_Decimal_Point->getPlaceHolder()) ?>" data-format-pattern="<?= HtmlEncode($Page->Default_Money_Decimal_Point->formatPattern()) ?>"<?= $Page->Default_Money_Decimal_Point->editAttributes() ?> aria-describedby="x_Default_Money_Decimal_Point_help">
...
<textarea data-table="languages" data-field="x_About_Text" name="x_About_Text" id="x_About_Text" cols="50" rows="5" placeholder="<?= HtmlEncode($Page->About_Text->getPlaceHolder()) ?>"<?= $Page->About_Text->editAttributes() ?> aria-describedby="x_About_Text_help"><?= $Page->About_Text->EditValue ?></textarea>
